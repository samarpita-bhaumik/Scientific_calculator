...
public class Scientific_Calculator_Test {
    ...
    public void testSquareRootFunc() {
        assertEquals("Value not Correct", 4, ob.squareRoot(16), 0);
    ...
    public void testFactorialFunc() {
        assertEquals("Value not Correct",120, ob.factorial(5),0);
    ...
    public void testLogNatural() {
        assertEquals("Value not Correct",2.772588722239781, ob.naturalLogFun(16),0);
    ...
    public void testPowerFunc() {
        assertEquals("Value not Correct",16, ob.powerFunc(2,4),0);
